...
const PRIMARY_FAQS: FAQItem[] = [
  {
    q: "¿Qué es Flikker?",
    a: "Flikker ayuda a que los clientes de tu negocio vuelvan más seguido. Cada visita puede acercarlos a una recompensa y, si un cliente deja de venir, Flikker puede intentar recuperarlo automáticamente.",
  },
  {
    q: "¿Cómo funciona?",
  ...
  },
  {
    ...
    a: "Vos definís la recompensa y cuántas visitas hacen falta para alcanzarla. Puede ser un café, un producto, un descuento, un 2×1 o cualquier beneficio que tenga sentido para tu negocio.",
  },
  {
    q: "¿Cómo se canjea una recompensa?",
    a: "Cuando el cliente completa las visitas necesarias, la recompensa se desbloquea y recibe un QR de canje. El empleado lo escanea con la cámara de su teléfono y confirma el beneficio.",
  },
  {
  ...
  {
    q: "¿Cuál es la diferencia con una tarjeta de fidelidad tradicional?",
    a: "Una tarjeta de papel solo muestra el progreso de alguien. Flikker además registra visitas, muestra quién vuelve, gestiona el canje y puede actuar cuando un cliente deja de venir.",
  },
  {
...
const ADDITIONAL_FAQS: FAQItem[] = [
  ...
  {
    q: "¿Cada visita cuenta para una recompensa?",
    a: "Sí, cuando la visita cumple las reglas configuradas por el negocio. Flikker evita que varios escaneos seguidos generen visitas duplicadas.",
  },
  {
    q: "¿Puedo elegir cuántas visitas necesita una recompensa?",
    a: "Sí. Podés definir, por ejemplo, que cada cinco visitas se desbloquee una recompensa.",
  },
  {
    q: "¿Se puede acelerar el progreso?",
    a: "Sí. El negocio puede reconocer el feedback completado después de una visita con un avance adicional.",
  },
  {
    q: "¿Tengo que regalar un premio por dejar una reseña positiva?",
    a: "No. El avance adicional se entrega por compartir la experiencia con el negocio, independientemente de la calificación. Dejar una reseña en Google es opcional y nunca genera avances adicionales.",
  },
  {
  ...
  },
  {
    ...
    a: "No exactamente. El progreso hacia una recompensa es la parte que ve el cliente. Flikker además registra recurrencia, permite medir quién vuelve y puede actuar cuando un cliente deja de venir.",
  },
  {
    q: "¿Flikker es un CRM?",
  ...
  },
  {
    ...
    a: "No necesitás un dispositivo especial para operar Flikker. El acceso puede ser mediante un QR y, cuando corresponda, también puede utilizarse NFC.",
  },
  {
